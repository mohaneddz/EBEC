...
import { motion, AnimatePresence } from 'motion/react'; // Use motion/react instead of motion/react for full features like layout
...
export const Accordion = ({ accordionData, activeIndex, onAccordionClick }) => {
    // Ensure motion/react is imported if not already
