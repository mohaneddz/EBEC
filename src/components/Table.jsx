    ...
    if (isMobile) {
        return (
            <div className="w-full px-2 sm:px-4">
                {/* Mobile Search Bar */}
                <div className="mb-4 sticky top-0 bg-gray-100 dark:bg-gray-800 py-2 z-10 px-2 -mx-2 sm:px-0 sm:mx-0 overflow-x-hidden
                ">
                    <input
                        type="text"
                        placeholder="Search..."
                                            ...
                                            return (
                                                <div key={column.key} className=" flex items-start pt-1">
                                                    <div className="relative">
                                                        <span className="relative block text-xs font-medium text-gray-500 dark:text-gray-400 w-24 flex-shrink-0">{column.label}:</span>
                                                        {(column.expandable || column.type === 'image' || String(value).length >= 35) && <IconEye size={14} className="absolute z-30 ml-1 text-gray-400 right-0 top-1" />}
                                                    </div>
                                                    <span
