            ...
            <div className="flex gap-4 flex-col w-full items-center p-4">
              ...
              >
                <Image
                  ...
                  src={card.src}
                  alt={card.title}
                  className="h-60 rounded-md object-cover object-top w-full"
                />
              </motion.div>
              <motion.div
                layout
                className="flex justify-center gap-2 pt-4 items-center flex-col w-full"
              >
                <motion.h3
                ...
                <p className="text-neutral-400 text-center text-base overflow-hidden truncate text-ellipsis w-full">
                  {card.description}
                </p>
              </motion.div>
            </div>
