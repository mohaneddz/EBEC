...
export default function ActivitiesSection() {
    ...
    const moveToNextPage = () => {
        // go to login if not logged in, else go to events page
        if (!user) {
    ...
    return (
        <div className="min-h-screen w-full max-w-7xl mx-auto py-16 md:py-24 lg:py-32 flex items-center justify-center content-center" ref={ref}>
            ...
            <div className="container mx-auto px-4 ">
                <div className="grid grid-cols-1 items-center justify-center content-center md:grid-cols-3 gap-24 md:gap-16 relative ">
                    ...
                    <div className="flex flex-col row-start-1 justify-center items-center md:items-start md:col-start-3 md:col-end-4 md:row-span-4 mt-8 md:mt-0 mb-16">
                        ...
                        <Button text={"Join US"} onClick={moveToNextPage} color1={'#FFC208'} color2={'#FDA916'} />
                    </div>
