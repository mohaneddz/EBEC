...
export default function UpcomingEventsSection({ id, ref }) {
    ...
    return (
        <div className="flex flex-col mb-8 mt-40 h-min min-h-screen " id={id}  >

            <svg className=" -z-10 translate-y-2 top-0" width="100%" height="192" viewBox="0 0 960 192" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
            ...
            <div className="flex justify-center items-center bg-primary-dark">
                <div className="z-10 flex flex-col justify-center items-center gap-32 lg:h-screen px-8 lg:px-16 py-20 bg-primary-dark">
                    ...
                    {loading ? <p ref={ref} className="text-2xl font-bold text-slate-700 text-center">Loading Upcoming Evnets...</p> :
                        <div ref={ref}>
                            {
                                data && (
