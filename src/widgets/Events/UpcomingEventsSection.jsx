...
export default function UpcomingEventsSection({ id, ref }) {
    ...
    return (
        <div className="flex flex-col min-h-screen mt-40 mb-8 h-min " id={id}  >
            ...
            <div className="flex items-center justify-center bg-primary-dark">
                <div className="z-10 flex flex-col items-center justify-center gap-32 px-8 py-20 lg:h-screen lg:px-16 bg-primary-dark">
                    ...
                    {loading ? <p ref={ref} className="text-2xl font-bold text-center text-slate-700">Loading Upcoming Evnets...</p> :
                        <div ref={ref}>
                            {
                                data && (
