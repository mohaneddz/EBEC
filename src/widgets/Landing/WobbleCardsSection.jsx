        ...
        <div id="WobbleCardSection"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 max-w-7xl mx-auto w-full px-4 md:px-6 lg:px-8">
                ...
                <motion.div 
                    ...
                    className="col-span-1 md:col-span-2 lg:col-span-2 h-full transparent min-h-[300px] md:min-h-[400px] lg:min-h-[300px]"
                >
                    <WobbleCard
                ...
                <motion.div 
                    ...
                    className="col-span-1 min-h-[250px] md:min-h-[300px]"
                >
                    <WobbleCard
                        containerClassName="h-full" 
                ...
                <motion.div 
                    ...
                    className="col-span-1 md:col-span-2 lg:col-span-3 transparent min-h-[400px] md:min-h-[500px] lg:min-h-[300px]"
                >
                    <WobbleCard
                        containerClassName="h-full" 
